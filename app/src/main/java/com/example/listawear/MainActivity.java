...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.dona, "Dona", "Dona"));
        items.add(new ItemsList(R.mipmap.dulce, "Dulce", "Dulce"));
        items.add(new ItemsList(R.mipmap.paleta, "Paleta", "Paleta"));
        items.add(new ItemsList(R.mipmap.dulce2, "Caramelo", "Caramelo"));
